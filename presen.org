...
#+BEGIN_ALIGNRIGHT
#+BEGIN_LARGER
機械学習とのコラボ: ヒューリスティック関数の自動生成/自動選択
#+END_LARGER
#+END_ALIGNRIGHT
...
|               | (未知の決定的効果)               |                                |
|               | Observe アクションなし(目隠し)   | Conformant Planning            |
|               | Observe アクションあり           | Contingent Planning            |
|---------------+----------------------------------+--------------------------------|
| Probabilistic | アクションの成功・失敗が分岐     |                                |
|               | (既知の非決定的効果)             | (PO)MDP Planning               |
